...
fusion=`sed -n '2p'  $usuario/MMDVMHost/MMDVMYSF.ini`
frbm=`sed -n '13p'  $usuario/MMDVMHost/MMDVMHost.ini`
frplus=`sed -n '13p'  $usuario/MMDVMHost/MMDVMHost.ini`
#BM
indi=$(awk "NR==2" $usuario/MMDVMHost/MMDVMHost.ini)
ide=$(awk "NR==3" $usuario/MMDVMHost/MMDVMHost.ini)
frec=$(awk "NR==13" $usuario/MMDVMHost/MMDVMHost.ini)
...
# masterradio=`expr substr $masterradio 1 30`
